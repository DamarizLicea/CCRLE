...
class SimpleEnv(MiniGridEnv):
    ...
    def q_learning_agent(self, alpha=0.1, gamma=0.9, epsilon=1.0, min_epsilon=0.01, decay_rate=0.95, max_steps=70, episodes=100):
        ...
        for episode in range(episodes):
            ...
            while steps < max_steps:
                ...
                reward = float(-0.1)  # Penalización por paso
