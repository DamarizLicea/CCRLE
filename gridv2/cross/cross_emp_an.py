from cross import SimpleCrossEnv  # Importar tu entorno
...
class EmpowermentAnalysis:
    ...
    def analyze_empowerment_growth(self):
        ...
        consecutive_steps = 0
        saturation_steps_threshold = 10  # Pasos consecutivos sin cambios para marcar punto de saturación

        with open("empowerment_cross_analysis.txt", "w") as file:
...
if __name__ == "__main__":
    ...
    env.reset()
    analysis = EmpowermentAnalysis(env, max_steps=150)
